...
![Visão geral do Agent Harness — "Se você não é o modelo, você é o harness"](images/image.png)
...
![Computador vs Agente LLM — mesma arquitetura Von Neumann, novo substrato](images/image-1.png)
...
![Diagrama circular dos 12 componentes do harness — Runtime no centro, Capabilities e Safety & Scale nas camadas externas](images/image-2.png)
...
![O loop de orquestração completo — da montagem do prompt à execução de ferramentas e atualização de contexto](images/image-3.png)
...
![Comparação entre frameworks — Claude Agent SDK, OpenAI Agents SDK, LangGraph, CrewAI e AutoGen convergem no mesmo padrão de loop, mas divergem em filosofia](images/image-4.png)
...
![O agente é o trabalhador, o LLM é o motor, o harness é o andaime — sem ele ninguém chega aos andares superiores](images/image-5.png)
...
![Mapa mental das 7 decisões de design de um agent harness](images/image-7.png)
...
![Espectro Thin vs Thick — de Claude Agent SDK (modelo decide tudo) até LangGraph (harness codifica a lógica)](images/image-6.png)
